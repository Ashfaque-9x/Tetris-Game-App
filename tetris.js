...
loopSound.volume = 0.015;
collideSound.volume = 0.04;
rotateSound.volume = 0.015;
sweepSound.volume = 0.25;
pauseSound.volume = 0.1;
gameoverSound.volume = 0.03;
highspinsSound.volume = 0.02;
...
function playerRotate(dir) {
  ...
  if (player.spins > 25) {
    ...
    highspinsSound.addEventListener('ended', () => {
